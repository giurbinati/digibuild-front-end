  ...
  return (
    ...
    >
      ...
      <Container maxWidth="xl" sx={{ padding: 0 }}>
        ...
        >
          <Grid container spacing={4} columns={16} alignItems="center" justify="center">
            <Grid item xs={8}>
              <Typography variant="h6" style={{ textAlign: 'center', fontSize: '3ch' }}>
              Invoicing Period 25.08.2022-26.09.2022</Typography>
            </Grid>
            ...
            <Grid item xs={8}>
              <Typography variant="h6" style={{ textAlign: 'center', fontSize: '3ch' }}>
              Invoicing Period 25.07.2022-25.08.2022</Typography>
            </Grid>
            <Grid item xs={8} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
              <ViewPdfApiButton apiUrl={''} />
            </Grid>
            <Grid item xs={8}>
              <Typography variant="h6" style={{ textAlign: 'center', fontSize: '3ch' }}>Invoicing Period 25.05.2022-27.06.2022</Typography>
            </Grid>
            <Grid item xs={8} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
              <ViewPdfApiButton apiUrl={''} />
            </Grid>
