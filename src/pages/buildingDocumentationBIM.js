...
export default function Home({ setList, list }) {
    ...
    return (
        <Container style={{ marginBottom: '40vh', marginTop: '30vh' }}>
      <Grid container spacing={4} columns={16} alignItems="center" justify="center" alignContent="center">
        <Grid item xs={8}>
          <Typography variant="h6" style={{ textAlign: 'center' }}>Design and plans of the building</Typography>
        </Grid>
        <Grid item xs={8}>
          <DownloadButtonFile />
        </Grid>
        <Grid item xs={8}>
          <Typography variant="h6" style={{ textAlign: 'center' }}>BIM</Typography>
        </Grid>
        <Grid item xs={8}>
          <DownloadButtonFile />
        </Grid>
